            ...
            <form id="AddForm" method="post" role="form" class="form-horizontal">
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" id="s_role_name" name="s_role_name" placeholder="" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">备注<span class="required" >&nbsp;</span></label>
                        <div class="col-md-6">
                            <textarea id="s_role_desc" name="s_role_desc" placeholder="" class="form-control"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">排序<span class="required" >&nbsp;</span></label>
                        <div class="col-md-6">
                            <input type="text" id="s_role_sort" name="s_role_sort" placeholder="" class="form-control">
                        </div>
                    </div>
                </div>
            </form>
